...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>PhD Candidate Leeah Richardson</title>
        <meta property="og:title" content="PhD Candidate Leeah Richardson" />
      </Helmet>
      <div data-role="Header" className="home-navbar-container">
        <div className="home-navbar">
          <img
            alt="image"
            src="/New Folder/longhornbee-200h.png"
            className="home-image"
          />
          <div className="home-links-container">
            <span className="home-link Navbar-Link">About</span>
            <span className="home-link1 Navbar-Link">Research</span>
            <span className="home-link2 Navbar-Link">
              Outreach &amp; Teaching
            </span>
            <span className="home-link3 Navbar-Link">Contact</span>
          </div>
        ...
        <div className="home-hero">
          <div className="home-hero-text-container">
            <h1 className="home-heading1">
              ...
              <br></br>
              <span>Foraging Decisions</span>
            </h1>
            <span className="home-text05">
              <span className="home-text06">Leeah Richardson</span>
              <span> - UT Austin PhD Candidate - Jha &amp; Muth labs </span>
            </span>
            <div className="home-container3">
              <div className="home-container4">
                <div className="home-container5">
                  <div className="home-cta-btn-container">
                    <Link to="/research" className="home-cta-btn Anchor button">
                      <span className="home-text08">RESEARCH</span>
                    </Link>
                  </div>
                </div>
              </div>
              <button className="home-cta-btn1 button">CV</button>
            </div>
          </div>
          <img
            alt="image"
            src="/New Folder/leeahpic-500w.jpeg"
      ...
      <div className="home-features">
        <div className="home-heading-container">
          <h2 className="home-text09 Section-Heading">Research</h2>
          <span className="home-text10 Section-Text">
            From basic questions exploring differences in cognitive abilities to
            applied work exploring the sublethal effects of pesticides on bees.
          </span>
        </div>
        <div className="home-cards-container">
          <div className="home-card">
            ...
            <div className="home-content-container">
              <span className="home-heading2 Card-Heading">Behavior</span>
          ...
          <div className="home-card1">
            ...
            <div className="home-content-container1">
              <span className="home-heading3 Card-Heading">Pesticides</span>
          ...
          <div className="home-card2">
            ...
            <div className="home-content-container2">
              <span className="home-heading4 Card-Heading">Brains</span>
      ...
      <div className="home-about">
        <div className="home-max-content-width-container">
          <div className="home-heading-container1">
            <h1 className="Section-Heading home-text14">
              Teaching &amp; Outreach
            </h1>
          </div>
